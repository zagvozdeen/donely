<template>
  ...
  <!--    <n-form ref="formRef" :rules="formRules" :model="formValue" @submit.prevent="onSubmit">-->
  <!--      <n-form-item label="Роль" path="role">-->
  <!--        <n-radio-group v-model:value="formValue.role" class="!hidden w-full sm:!flex" size="small">-->
  <!--          <n-radio-button-->
  ...
  <!--          />-->
  <!--        </n-radio-group>-->
  <!--        <n-select v-model:value="formValue.role" class="block sm:hidden" :options="rolesOptions" />-->
  <!--      </n-form-item>-->
  ...
  <!--      <n-form-item label="Повторите пароль" path="password_confirmation">-->
  <!--        <n-input-->
  ...
  <!--        <n-button attr-type="submit" type="primary" class="flex-1"> Создать аккаунт </n-button>-->
  <!--      </n-form-item>-->
  <!--    </n-form>-->

  <!--    <span class="text-center"-->
  <!--      >Уже есть аккаунт?-->
  <!--      <router-link :to="{ name: 'login' }" class="underline"> Войти в аккаунт </router-link></span-->
  <!--    >-->
  <!--  </div>-->
</template>
...
<!--import { useRegister } from '@/composables/useAuthStore.ts'-->
<!--import { useRouter } from 'vue-router'-->
<!--import { PageExpose, UserRole, UserRoleTranslates } from '@/types.ts'-->
<!--import { Submitter } from '@/composables/useForm.ts'-->
...
<!--  { label: UserRoleTranslates[UserRole.Creator], value: UserRole.Creator },-->
<!--]-->

<!--const onSubmit = () => {-->
<!--  submitter.submit(formRef.value, async () => {-->
<!--    await useRegister(formValue)-->
